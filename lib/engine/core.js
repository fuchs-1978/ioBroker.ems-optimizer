...
function createStates() {
    const r = CFG.root;
    stateDef(`${r}.System.Version`, '0.8.0', 'string', 'text', '', 'EMS-Version');
    ...
    configDef(`${r}.Config.SlowControlCycle_s`, 10, 'number', 'value.interval', 's', 'Regelzyklus Wallboxen und Heizstaebe');
    ...
    configDef(`${r}.Config.DHWHouseConnectionLimit_A`, 50, 'number', 'value.current', 'A', 'EHZ-Regelgrenze Hausanschluss je Phase');
    ...
    stateDef(`${r}.Control.SlowCycleSeconds`, 10, 'number', 'value.interval', 's', 'Reglerzyklus langsame Verbraucher');
