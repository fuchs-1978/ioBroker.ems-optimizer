function observe() {
    ...
    const heatPump = Math.max(0, Math.round(readFreshNumber(CFG.dp.heatPumpPower, invalid,
        Boolean(getState(`${CFG.root}.Devices.HeatPump.Present`)?.val))));
    ...
    write(`${CFG.root}.Actual.HeatPump_W`, heatPump);
