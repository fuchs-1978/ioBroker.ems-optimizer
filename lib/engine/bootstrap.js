createStates();
write(`${CFG.root}.System.Version`, '0.11.0');
...
log('EMS V0.11.0 mit Gerätefreigaben und konfigurierbarer Trinkwasserkennlinie gestartet – keine Gerätesteuerung', 'info');
