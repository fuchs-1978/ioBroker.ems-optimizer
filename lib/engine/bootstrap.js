createStates();
write(`${CFG.root}.System.Version`, '0.13.0');
write(`${CFG.root}.System.ActiveScriptAudit_JSON`, JSON.stringify({
    ...
    correctedInAdapter: [
        ...
        'Gemeinsamer Produktivbetrieb Wallbox/EHZ ist bis zum separaten Kombinationstest gesperrt.'
    ]
}));
...
log('EMS V0.13.0 mit optionalem Wallbox-Einzeltest gestartet', 'info');
