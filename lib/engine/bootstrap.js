createStates();
write(`${CFG.root}.System.Version`, '0.7.0');
write(`${CFG.root}.System.ActiveScriptAudit_JSON`, JSON.stringify({
    ...
    integrated: [
        'PV_Ueberschuss_Verteilung: feste Wallbox-Grundränge, socfrei, alw, Fahrzeugstatus und javascript.0.ev.prio',
        ...
        'PV_Ueberschuss_Stufen/Nacht: 2-s-NVP-Simulation innerhalb des Fahrplans'
    ],
    intentionallyLocal: [
    ...
    correctedInAdapter: [
        ...
        'Der Adapter schreibt weiterhin keine realen Aktoren.'
    ]
}));
...
log('EMS V0.7.0 mit abgeglichener Vehicle-, 50/50-Trinkwasser- und NVP-Simulation gestartet – keine Gerätesteuerung', 'info');
