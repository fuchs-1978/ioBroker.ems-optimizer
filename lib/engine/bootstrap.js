createStates();
write(`${CFG.root}.System.Version`, '0.9.0');
...
log('EMS V0.9.0 mit strukturierter Fahrzeugkonfiguration und paralleler Wallbox-Simulation gestartet – keine Gerätesteuerung', 'info');
