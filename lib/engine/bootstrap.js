createStates();
write(`${CFG.root}.System.Version`, '0.12.2');
write(`${CFG.root}.System.ActiveScriptAudit_JSON`, JSON.stringify({
    ...
    correctedInAdapter: [
        ...
        'Nur der Trinkwasser-EHZ kann nach dreifacher Freigabe produktiv schreiben; alle anderen Geräte bleiben Simulation.'
    ]
}));
...
schedule('*/10 * * * * *', updateDhwProductionOutput);
...
log('EMS V0.12.2 mit Trinkwasser-EHZ-Ausgang, Watchdog und direkter Phasenstromprüfung gestartet', 'info');
