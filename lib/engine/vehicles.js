 ...
 * Reiner Beobachter: keine Schreibzugriffe auf go-e oder javascript.0.ev.
 */
...
function updateVehicles() {
    ...
    for (let wb = 0; wb < 3; wb++) {
        ...
        const phases = Math.max(1, Math.min(3, Math.round(readNumber(CFG.dp.wallboxPhases[wb], 1))));
