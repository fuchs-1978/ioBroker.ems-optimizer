...
function createStates() {
    const r = CFG.root;
    stateDef(`${r}.System.Version`, '0.2.9', 'string', 'text', '', 'EMS-Version');
...
createStates();
write(`${CFG.root}.System.Version`, '0.2.9');
...
log('EMS V0.2.9 Beobachter/Fahrplaner gestartet – keine Gerätesteuerung', 'info');
