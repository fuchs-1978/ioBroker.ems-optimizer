...
const FIELD_TO_MAPPING = Object.freeze({
    ...
    batterySetpointId: 'DP_BATTERY_SETPOINT',
    batteryHeartbeatId: 'DP_BATTERY_HEARTBEAT',
    batteryOnlineId: 'DP_BATTERY_ONLINE',
    batteryManualModeId: 'DP_BATTERY_MANUAL_MODE',
    batteryLocalModeId: 'DP_BATTERY_LOCAL_MODE',
    batteryFaultId: 'DP_BATTERY_FAULT',
    ...
    heatingSetpointId: 'DP_HEAT_SETPOINT',
    heatingConnectionId: 'DP_HEAT_CONNECTION',
    heatingCoolingActiveId: 'DP_HEAT_COOLING_ACTIVE',
    heatingCoolingHeartbeatId: 'DP_HEAT_COOLING_HEARTBEAT',
    heatingOutput1Id: 'DP_HEAT_OUTPUT1',
    heatingOutput2Id: 'DP_HEAT_OUTPUT2',
    heatingOutput3Id: 'DP_HEAT_OUTPUT3',
    heatingOutletTempId: 'DP_HEAT_OUTLET_TEMP',
